...
if (get_theme_mod('ethic_front_team_members_check')) {
...
<section class="team-member-area">
    ...
    <div class="team-member-title-area" id="team-title">
            <div class="team-member-title section-title">
                 <?php if ( get_theme_mod('ethic_team_title') !='' ) {  ?><h3><?php echo esc_html(get_theme_mod('ethic_team_title')); ?></h3>
                  <?php } else {  ?> <h3 class="title"><?php esc_html_e('Team', 'ethic') ?></h3>
                           <?php } ?>
...
<?php
  ...
  <section class="team-member-area">
    ...
    <div class="team-member-title-area" id="team-title">
            <div class="team-member-title section-title">
                <h3 class="title"><?php esc_html_e(' Our Team Members', 'ethic') ?></h3>
                    <p><?php esc_html_e('The Dedicated Team Behind Our Successful Projects', 'ethic') ?> </p>
